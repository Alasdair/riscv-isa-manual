...
sail::execute[part=body,dedent,clause="ITYPE(_,_,_,_)"]
...
sail::execute[part=body,dedent,clause="UTYPE(_,_,_)"]
...
sail::execute[part=body,dedent,clause="RTYPE(_,_,_,_)"]
...
sail::execute[part=body,dedent,clause="RISCV_JAL(_,_)"]
...
sail::execute[part=body,dedent,clause="RISCV_JALR(_,_,_)"]
...
sail::execute[part=body,dedent,clause="BTYPE(_,_,_,_)"]
...
sail::execute[part=body,dedent,clause="FENCE(_,_)"]
...
sail::execute[part=body,dedent,clause="FENCE_TSO(_,_)"]
...
sail::execute[part=body,dedent,clause="ECALL()"]
